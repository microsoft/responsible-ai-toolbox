...
_widget_js_directory = os.path.join("error_analysis", "widget", "js")
_visualization_directory = os.path.join("visualization", "dashboard")
...
def main(argv):
    ...
    if args.use_local_changes:
        ...
        with _LogWrapper("copying built visualizations into error analysis widget dependencies"):
