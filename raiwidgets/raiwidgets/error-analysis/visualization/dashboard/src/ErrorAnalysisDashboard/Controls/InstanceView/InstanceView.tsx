...
export class InstanceView extends React.PureComponent<IInstanceViewProps, IInstanceViewState> {
    ...
    constructor(props:IInstanceViewProps) {
        ...
        this.pivotItems.push({headerText: localization.correctPrediction, itemKey: predictionTabKeys.correctPredictionTab});
        this.pivotItems.push({headerText: localization.wrongPrediction, itemKey: predictionTabKeys.wrongPredictionTab});
    }
    ...
    public render(): React.ReactNode {
        ...
        return (
            <div className={InstanceView.classNames.pivotWrapper}>
                ...
                {this.state.activePredictionTab === predictionTabKeys.wrongPredictionTab && (
                    <div className="tabularDataView">
                        <TabularDataView
                            theme={this.props.theme}
                            messages={this.props.messages}
