...
export class TabularDataView extends React.PureComponent<ITabularDataViewProps, ITabularDataViewState> {
    private _rows: any[];
    ...
    constructor(props:ITabularDataViewProps) {
        ...
        for (let i = 0; i < viewedCols; i++) {
            this._columns.push({key: 'column' + i, name: featureNames[i], fieldName: i.toString(), minWidth: 100, maxWidth: 200, isResizable: true})
        }
    }
