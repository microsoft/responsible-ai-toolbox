...
import { Breadcrumb, IBreadcrumbItem, IBreadcrumbStyles } from 'office-ui-fabric-react/lib/Breadcrumb';
...
export class Navigation extends React.PureComponent<INavigationProps> {
            ...
            items = [
                {
                    ...
                    onClick: (e: React.MouseEvent<HTMLElement>, item: IBreadcrumbItem) => this._errorDetectorBreadcrumbClicked(e, item)
                }
            ]
        }
        ...
        if (item.onClick || item.href) {
            return (
                <Link
                    ...
                    href={item.href}
                    onClick={ (e: React.MouseEvent<HTMLElement>) => this._errorDetectorBreadcrumbClicked(e, item) }
                    color="blue"
                >
                    {item.text}
                </Link>
    ...
    private _errorDetectorBreadcrumbClicked(ev: React.MouseEvent<HTMLElement>, item: IBreadcrumbItem): void {
