...
import { IErrorAnalysisDashboardProps, IMultiClassLocalFeatureImportance, ISingleClassLocalFeatureImportance } from "./Interfaces";
...
export class ErrorAnalysisDashboard extends React.PureComponent<IErrorAnalysisDashboardProps, IErrorAnalysisDashboardState> {
    private static iconsInitialized = false;

    private static initializeIcons(props: IErrorAnalysisDashboardProps): void {
        if (ErrorAnalysisDashboard.iconsInitialized === false && props.shouldInitializeIcons !== false) {
    ...
    private static buildModelMetadata(props: IErrorAnalysisDashboardProps): IExplanationModelMetadata {
        ...
        if (featureNames !== undefined) {
            ...
            featureNames = ErrorAnalysisDashboard.buildIndexedNames(featureLength, localization.defaultFeatureNames);
        ...
        if (!classNames || classNames.length !== classLength) {
            classNames = ErrorAnalysisDashboard.buildIndexedNames(classLength, localization.defaultClassNames);
        }
    ...
    private static getClassLength: (props: IErrorAnalysisDashboardProps) => number
    = (memoize as any).default((props: IErrorAnalysisDashboardProps): number  => {
    ...
    private static buildGlobalProperties(props: IErrorAnalysisDashboardProps): IGlobalExplanationProps {
    ...
    public static buildInitialExplanationContext(props: IErrorAnalysisDashboardProps): IErrorAnalysisDashboardState {
    ...
    constructor(props: IErrorAnalysisDashboardProps) {
        ...
        this.state = ErrorAnalysisDashboard.buildInitialExplanationContext(_.cloneDeep(props));

        this.pivotItems.push({headerText: localization.dataExplorerView, itemKey: globalTabKeys.dataExplorerTab});
        this.pivotItems.push({headerText: localization.globalExplanationView, itemKey: globalTabKeys.globalExplanationTab});
        this.pivotItems.push({headerText: localization.localExplanationView, itemKey: globalTabKeys.localExplanationTab});
        ...
        return (
                <div className={classNames.page} style={{maxHeight: "1000px"}}>
                    ...
                    <MainMenu
                        ...
                        onSettingsPanelClick={() => this.setState({openSettingsPanel: true})}
                    ...
                    <div>
                        <Customizer settings={{ hostId: this.layerHostId }}>
                            ...
                            {this.state.viewType === viewTypeKeys.explanationView && (
                                <div className={ErrorAnalysisDashboard.classNames.pivotWrapper} style={{height: "820px"}}>
                                    <Pivot
                                    ...
                                    {this.state.activeGlobalTab === globalTabKeys.localExplanationTab && (
                                        <InstanceView
                                            theme={this.props.theme}
                                            messages={this.props.stringParams ? this.props.stringParams.contextualHelp : undefined}
                            ...
                            <FeatureList
                                ...
                                saveFeatures={(features: string[]) => this.setState({selectedFeatures: features})}
                                features={this.props.features}
                            />
                            <CohortSettings
