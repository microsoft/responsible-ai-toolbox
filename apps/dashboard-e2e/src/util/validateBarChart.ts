...
export function checkNumBars(locator: string, expectedNumBars: number) {
...
export function checkYAxisLabel(locator: string) {
...
export function checkNumLabels(locator: string, expectedNumLabels: number) {
