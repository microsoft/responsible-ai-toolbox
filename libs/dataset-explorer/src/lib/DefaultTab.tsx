...
export class IDefaultTabProps {}

export interface IDefaultTabState {
  xDialogOpen: boolean;
  yDialogOpen: boolean;
...
export class DefaultTab extends React.Component<
  IDefaultTabProps,
  IDefaultTabState
> {
  ...
  public constructor(props: IDefaultTabProps) {
    super(props);
  ...
  public componentDidUpdate(
    _preProp: IDefaultTabProps,
    preState: IDefaultTabState
  ): void {
