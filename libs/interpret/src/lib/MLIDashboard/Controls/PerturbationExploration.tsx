              ...
              <PredictionLabel
                ...
                predictedProbabilities={
                  this.props.explanationContext.testDataset.probabilityY
                    ? this.props.explanationContext.testDataset.probabilityY[this.props.datapointIndex]
                    : undefined
                }
              />
            </div>
            ...
            (featureValue, featureIndex) => {
              return (
                <FeatureEditingTile
                  ...
                  enumeratedValues={
                    (this.props.explanationContext.modelMetadata.featureRanges[featureIndex] as ICategoricalRange)
                      .uniqueValues
                  }
