...
import { AccessibleChart, IPlotlyProperty, PlotlyMode, IData } from "@responsible-ai/mlchartlib";
import {
  ChoiceGroup,
  IChoiceGroupOption,
  Icon,
...
export class WhatIfTab extends React.PureComponent<IWhatIfTabProps, IWhatIfTabState> {
  ...
  public render(): React.ReactNode {
    ...
    const canRenderChart =
      cohortLength < NewExplanationDashboard.ROW_ERROR_SIZE || this.props.chartProps.chartType !== ChartTypes.Scatter;
    ...
    return (
      <div className={classNames.page}>
        ...
        <div className={classNames.mainArea}>
          <div className={this.state.isPanelOpen ? classNames.expandedPanel : classNames.collapsedPanel}>
            ...
            {!this.state.isPanelOpen && <IconButton iconProps={{ iconName: "ChevronLeft" }} onClick={this.openPanel} />}
          </div>
              ...
              <div className={classNames.chartWithAxes} id={this.chartAndConfigsId}>
                ...
                <div className={classNames.chartWithVertical}>
                  ...
                  {!canRenderChart && (
                    <div className={classNames.missingParametersPlaceholder}>
                      <div className={classNames.missingParametersPlaceholderSpacer}>
                        <Text block variant="large" className={classNames.faintText}>
            ...
            <div className={classNames.rightJustifiedContainer}>
              ...
              {this.state.iceTooltipVisible && (
                ...
                >
                  <div className={classNames.calloutWrapper}>
                    <div className={classNames.calloutHeader}>
                      <Text className={classNames.calloutTitle}>{localization.WhatIfTab.icePlot}</Text>
                    </div>
                    <div className={classNames.calloutInner}>
                      ...
                      <div className={classNames.calloutActions}>
                        <Link
                          ...
                          href={"https://christophm.github.io/interpretable-ml-book/ice.html#ice"}
                          target="_blank"
                        >
  ...
  private buildExistingPredictionLabels(classNames: IProcessedStyleSet<IWhatIfTabStyles>): React.ReactNode {
    if (this.props.metadata.modelType !== ModelTypes.regression) {
      ...
      const trueClass = this.props.jointDataset.hasTrueY ? row[JointDataset.TrueYLabel] : undefined;
      const predictedClass = this.props.jointDataset.hasPredictedY ? row[JointDataset.PredictedYLabel] : undefined;
      ...
      if (this.props.jointDataset.hasPredictedProbabilities) {
        ...
        const tooltipClasses = sortedProbs.map(index => {
          const className = this.props.jointDataset.metaDict[JointDataset.PredictedYLabel].sortedCategoricalValues[
            index
          ];
          return (
            ...
            <div>
              {trueClass !== undefined && (
                <div>
                  ...
                  <Text variant="small">
                    {this.props.jointDataset.metaDict[JointDataset.PredictedYLabel].sortedCategoricalValues[trueClass]}
                  </Text>
                </div>
              )}
              <div>
      ...
      const row = this.props.jointDataset.getRow(this.state.selectedWhatIfRootIndex);
      const trueValue = this.props.jointDataset.hasTrueY ? row[JointDataset.TrueYLabel] : undefined;
      const predictedValue = this.props.jointDataset.hasPredictedY ? row[JointDataset.PredictedYLabel] : undefined;
      return (
        <div className={classNames.predictedBlock}>
          <div>
            {trueValue !== undefined && (
  ...
  private generatePlotlyProps(
    ...
    plotlyProps.data[1] = {
      ...
      marker: {
        symbol: "star",
        size: 12,
        color: this.state.customPoints.map((_, i) => FabricStyles.fabricColorPalette[WhatIfTab.MAX_SELECTION + 1 + i]),
      },
    };
