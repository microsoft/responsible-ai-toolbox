...
export class EbmExplanation extends React.PureComponent<IEbmProps, IEbmState> {
  ...
  private static buildContinuousSeries: (
    coordinates: IMultiClassBoundedCoordinates,
    classes: string[],
  ) => IData[] = (memoize as any).default((coordinates: IMultiClassBoundedCoordinates, classes: string[]): IData[] => {
  ...
  private static buildPlotlyProps: (
    ...
    (featureIndex: number, explanationContext: IExplanationContext): IPlotlyProperty => {
      ...
      return {
        ...
        layout: {
          ...
          yaxis: {
            automargin: true,
            title:
              ebmObject.displayParameters && ebmObject.displayParameters.yAxisLabel
