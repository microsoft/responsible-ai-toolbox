module.exports = {
  ...
  localFeatureImportance: "[TdtNk][ÃªLocal Feature Importance !!! !!! !]",
  ice: "[prPCi][Í@ICE !!]",
  ...
  IcePlot: {
    ...
    noModelError:
      "[BVZkF][âÀPlease provide an operationalized model to explore predictions in ICE plots. !!! !!! !!! !!! !!! !!! !!! ]",
