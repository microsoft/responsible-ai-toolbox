module.exports = {
  ...
  AggregateImportance: {
    ...
    noColor: "Nessuno",
    tooManyRows:
      "Il set di dati fornito è più grande di quello che questo grafico può supportare"
  },
  BarChart: {
    classLabel: "Classe: {0}",
    sortBy: "Ordina per",
  ...
  IcePlot: {
    ...
    probabilityLabel: "Probabilità: {0}",
    noModelError:
      "Fornire un modello operativo per esplorare le stime nei tracciati ICE.",
  ...
  GlobalTab: {
    ...
    legendHelpText:
      "Attivare e disattivare le coorti nel tracciato facendo clic sugli elementi della legenda.",
    sortBy: "Ordina per",
    viewDependencePlotFor: "Visualizza tracciato delle dipendenze per:",
    datasetCohortSelector: "Seleziona una coorte di set di dati",
    aggregateFeatureImportance: "Importanza delle caratteristiche aggregate",
    missingParameters:
      "Questa scheda richiede che sia fornito il parametro di importanza della caratteristica locale.",
  ...
  ModelPerformance: {
    ...
    missingParameters:
      "Questa scheda richiede che sia fornita la matrice di valori stimati del modello.",
    missingTrueY:
  ...
  DatasetExplorer: {
    ...
    chartType: "Tipo di grafico",
    missingParameters:
      "Questa scheda richiede che sia fornito un set di dati di valutazione.",
    noColor: "Nessuno"
  },
  DependencePlot: {
  ...
  WhatIfTab: {
    ...
    panelPlaceholder:
      "Per effettuare stime per i nuovi punti dati, è necessario un modello.",
    cohortPickerLabel: "Seleziona una coorte di set di dati da esplorare",
    scatterLegendText:
      "Attivare e disattivare i punti dati nel tracciato facendo clic sugli elementi della legenda.",
    ...
    icePlot:
      "Tracciato Aspettativa condizionale individuale (ICE, Individual Conditional Expectation)",
    ...
    featureImportanceGetStartedText:
      "Seleziona un punto per visualizzare l'importanza della caratteristica",
    iceLackingParameters:
      "I tracciati ICE richiedono un modello operativo per fare stime per punti dati ipotetici.",
    IceGetStartedText:
      "Selezionare un punto o creare un punto di simulazione per visualizzare i tracciati ICE",
    ...
    trueValue: "Valore true: ",
    "trueValue.comment":
      "prefisso per l'etichetta effettiva per la regressione",
  ...
  CohortEditor: {
    ...
    defaultFilterState:
      "Selezionare un filtro per aggiungere i parametri alla coorte del set di dati.",
  ...
  ValidationErrors: {
    ...
    inconsistentDimensions:
      "Dimensioni incoerenti. {0} contiene dimensioni {1}, previsto {2}",
    notNonEmpty: "Input {0} non contiene una matrice non vuota",
    varyingLength:
      "Dimensioni incoerenti. {0} contiene elementi di lunghezza variabile",
    notArray:
      "{0} non contiene una matrice. È prevista una matrice di dimensione {1}",
    errorHeader:
      "Alcuni parametri di input sono incoerenti e non verranno usati: ",
    datasizeWarning:
    ...
    datasizeError:
      "La coorte selezionata è troppo grande, aggiungere i filtri per ridurre le dimensioni della coorte.",
