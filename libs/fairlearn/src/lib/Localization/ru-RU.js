module.exports = {
  ...
  accuracyMetricLegacy: "Метрика производительности",
  errorOnInputs:
  ...
  ModelComparison: {
    ...
    insights: "Аналитика",
    insightsText1:
      'Диаграмма показывает функцию "{0}" и несоответствие моделей ({1}).',
    insightsText2:
      'Функция "{0}" имеет диапазон от {1} до {2}, а несоответствие — от {3} до {4}.',
    insightsText3:
  ...
  Report: {
    ...
    classificationAccuracyHowToRead1:
      "Линейчатая диаграмма показывает распределение ошибок в каждой группе.",
  ...
  Metrics: {
    ...
    precisionDescription:
      "Доля точек данных с корректной классификацией среди тех, что классифицированы как 1.",
    recallDescription:
