module.exports = {
  ...
  ModelComparison: {
    ...
    insightsText1:
      'Das Diagramm zeigt "{0}" und die Abweichung bei {1} Modellen.',
    insightsText2:
      '"{0}" liegt im Bereich zwischen {1} und {2}. Die Abweichung reicht von {3} bis {4}.',
    insightsText3:
      'Das genaueste Modell erzielt für "{0}" einen Wert von {1} und eine Abweichung von {2}.',
    insightsText4:
  ...
  Feature: {
    header:
      "Anhand welcher Features möchten Sie die Fairness Ihres Modells auswerten?",
    body:
  ...
  Metrics: {
    ...
    logLoss: "Log Loss",
    accuracyDescription:
      "Der Anteil der Datenpunkte, die korrekt klassifiziert werden.",
    ...
    rmseDescription:
      "Quadratwurzel des Durchschnitts von quadratischen Fehlern.",
    mseDescription: "Der Durchschnitt aus quadratischen Fehlern.",
    meanAbsoluteErrorDescription:
      "Der Durchschnitt der absoluten Fehlerwerte. Stabiler bei Ausreißern als MSE.",
    r2Description:
      "Der Anteil der Varianz in den Beschriftungen, die vom Modell erklärt werden.",
    aucDescription:
