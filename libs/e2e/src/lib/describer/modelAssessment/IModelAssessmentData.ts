...
export enum RAINotebookNames {
  "CensusClassificationModelAssessment" = "responsibleaidashboard-census-classification-model-assessment.py",
  "CensusClassificationModelAssessmentNewModelOverviewExperience" = "responsibleaidashboard-census-classification-model-assessment.py",
